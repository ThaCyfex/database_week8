...
# This API is designed to manage tasks for users in a South African context, ensuring scalability and flexibility.
...
@app.get("/")
async def root():
    return {"message": "Welcome to the Advanced Task Manager API"}

...
# This model is designed to handle user data for a South African context, ensuring flexibility for local use cases.
...
class User(Base):
    ...
    full_name = Column(String(100))  # Full name of the user, e.g., "Sipho Nkosi"
    ...
    # Add relationship for categories
    categories = relationship("Category", back_populates="created_by", cascade="all, delete-orphan")

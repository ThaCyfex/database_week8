...
VALUES 
('admin@example.com', 'admin', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Admin User', TRUE),
('user@example.com', 'user1', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Regular User', FALSE);

INSERT INTO task_manager.tasks (title, description, status, priority, owner_id, due_date)
VALUES
('Complete project', 'Finish the API implementation', 'pending', 'high', 1, '2023-06-15'),
('Write documentation', 'Document all endpoints', 'in_progress', 'medium', 1, '2023-06-10'),
('Review code', 'Peer review of new features', 'pending', 'medium', 2, '2023-06-12');

INSERT INTO task_manager.categories (name, description, created_by)
VALUES
('work', 'Tasks related to job or professional work', 1),
